              ...
              <div className="space-y-6 text-white">
                ...
                <div className="space-y-4">
                  ...
                  <p className="max-w-2xl text-base text-white/70 md:text-lg">
                    Explore a carefully curated marketplace of verified companies, vibrant startups, and established
                    enterprises. Filter by category, city, or feature to pinpoint the perfect partner for your next project.
                  </p>
                </div>
